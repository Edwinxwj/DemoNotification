...
import static sg.edu.rp.c346.demonotification.R.id.btnNotify2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //creating the small icon
                builder.setSmallIcon(R.mipmap.ic_launcher);
                builder.setContentIntent(pIntent);
                builder.setAutoCancel(true);

                //Create current default notification ringtone.
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Used to launch a notification with Big Text Style.
